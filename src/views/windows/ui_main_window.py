...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy7.setHeightForWidth(self.student_summary_result_lbl.sizePolicy().hasHeightForWidth())
        self.student_summary_result_lbl.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.summary_timespan_result_lbl.sizePolicy().hasHeightForWidth())
        self.summary_timespan_result_lbl.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.filter_frame.sizePolicy().hasHeightForWidth())
        self.filter_frame.setSizePolicy(sizePolicy8)
