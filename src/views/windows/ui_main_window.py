...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.more_info_btn = QPushButton(self.table_all_results_frame)
        self.more_info_btn.setObjectName(u"more_info_btn")

        self.verticalLayout_5.addWidget(self.more_info_btn)
