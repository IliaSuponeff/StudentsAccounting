...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout.addWidget(self.vLine_2)
        ...
        sizePolicy8.setHeightForWidth(self.from_date_lbl.sizePolicy().hasHeightForWidth())
        self.from_date_lbl.setSizePolicy(sizePolicy8)
        ...
        sizePolicy8.setHeightForWidth(self.to_date_lbl.sizePolicy().hasHeightForWidth())
        self.to_date_lbl.setSizePolicy(sizePolicy8)
        ...
        sizePolicy9.setHeightForWidth(self.all_results_table_view.sizePolicy().hasHeightForWidth())
        self.all_results_table_view.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHeightForWidth(self.student_visits_table_view.sizePolicy().hasHeightForWidth())
        self.student_visits_table_view.setSizePolicy(sizePolicy10)

        self.verticalLayout_2.addWidget(self.student_visits_table_view)


        self.horizontalLayout.addWidget(self.visits_info_frame)
